...
const translations: Record<Language, Record<TranslationKey, string>> = {
    en: {
        ...
        delete_confirm: "Are you sure you want to PERMANENTLY delete this sheet? This action cannot be undone.",
        ...
        delete_user_confirm: "Are you sure you want to PERMANENTLY delete this user? This action cannot be undone.",
    ...
    jp: {
        ...
        delete_user_confirm: "このユーザーを完全に削除してもよろしいですか？この操作は取り消せません。",
