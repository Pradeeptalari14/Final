    ...
    return (
        ...
        >
            ...
            >
                ...
                {items.length > 0 && !hideItems && (
                    <span className="text-xs font-mono opacity-50">{items.length}</span>
                )}
            </div>
                            ...
                            >
                                {isMainHeader ? (
                                    ...
                                    <div className="text-center">
                                        ...
                                        <span className="text-[9px] opacity-80 uppercase leading-none mt-1 block text-center">
                                            {f.label}
                                        </span>
                                    </div>
                                )}
