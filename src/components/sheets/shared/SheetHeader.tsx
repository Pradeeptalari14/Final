...
export const SheetHeader: React.FC<SheetHeaderProps> = ({ data, onChange, isLocked, isCompleted, errors = [], type }) => {
    ...
    return (
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-${isStaging ? '3' : '4'} xl:grid-cols-${isStaging ? '3' : '5'} gap-4 p-4 md:p-6 bg-slate-50/50 border-b border-slate-200`}>
            {/* Shift */}
            ...
            {/* Supervisor Name - Always visible for both */}
