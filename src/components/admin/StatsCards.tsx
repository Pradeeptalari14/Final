...
export function StatsCards({ currentUser, activeTab, onTabChange }: StatsCardsProps) {
    return (
                ...
                >
                    <CardContent className="p-4 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs font-semibold text-slate-500 dark:text-slate-400">Locked</div>
                        </div>
                    </CardContent>
                </Card>
            )}
