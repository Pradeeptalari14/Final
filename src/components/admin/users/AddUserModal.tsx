...
export const AddUserModal: React.FC<AddUserModalProps> = ({ isOpen, onClose, onSuccess, settings }) => {
                ...
                <form onSubmit={handleAddUser} className="p-4 space-y-4">
                    ...
                    <div className="pt-2 flex justify-end gap-2">
                        ...
                        <Button type="submit" disabled={loading} className="bg-primary text-primary-foreground">
                            {loading && <Loader2 className="animate-spin mr-2" size={16} />} {t('create_user', settings.language)}
                        </Button>
                    </div>
                </form>
            </motion.div>
